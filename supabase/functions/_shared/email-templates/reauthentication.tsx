...
export const ReauthenticationEmail = ({ token }: ReauthenticationEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your C24 Club verification code</Preview>
    <Body style={main}>
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '28px', fontWeight: 'bold' as const, color: 'hsl(205, 65%, 45%)', margin: '0 0 30px', letterSpacing: '4px' }
