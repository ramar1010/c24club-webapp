...
Deno.serve(async () => {
  ...
  const staticPages = [
    ...
    { loc: "/csae-policy", priority: "0.3", changefreq: "yearly" },
    ...
    { loc: "/ome-tv-alternative", priority: "0.9", changefreq: "weekly" },
    { loc: "/monkey-app-alternative", priority: "0.9", changefreq: "weekly" },
  ];
