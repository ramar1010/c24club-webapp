...
BEGIN
  ...
  DELETE FROM public.waiting_queue WHERE member_id = target_user_id::text;
  ...
  DELETE FROM public.user_reports WHERE reporter_id = target_user_id OR reported_user_id = target_user_id::text;
