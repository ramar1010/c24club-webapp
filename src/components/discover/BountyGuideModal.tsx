...
const methods: Method[] = [
  {
    ...
    how: [
      "Have a real DM conversation with a guy — you both send at least one message.",
      "Once that happens, he's linked to you for 30 days.",
      "If he upgrades to VIP during those 30 days, the minutes land in your balance automatically.",
    ],
    tips: [
      "125 minutes when he buys Basic VIP",
      "500 minutes when he buys Premium VIP",
      "A real conversation means you both sent a message — either of you can start it",
      "Your 30-day link stays locked even if he goes offline, unmatches, or blocks",
