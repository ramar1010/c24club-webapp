...
const DiscoverProfileEditor = ({ userId }: DiscoverProfileEditorProps) => {
  ...
  return (
    <div className="mx-3 mt-2 space-y-2 sm:mx-4">
      {imageUrl && (
        <div className="rounded-lg border border-white/10 bg-white/5 px-3 py-2">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white text-xs font-semibold">Your Discover selfie</p>
              <div className={`mt-0.5 inline-flex items-center gap-1 text-[11px] font-semibold ${statusBadge.color}`}>
            ...
            <button
              ...
              className="flex h-8 items-center gap-1 rounded-md border border-pink-500/30 bg-pink-500/15 px-2.5 text-xs font-semibold text-pink-300 transition-colors hover:bg-pink-500/25"
            >
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-md bg-white/5 text-white/60 transition-colors hover:bg-white/10 hover:text-white"
              aria-label={expanded ? "Close profile editor" : "Edit profile"}
              title={expanded ? "Close profile editor" : "Edit profile"}
            >
