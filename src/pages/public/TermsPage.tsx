      ...
      <div className="max-w-3xl mx-auto px-5 py-8 space-y-10 text-sm leading-relaxed text-neutral-300">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li><strong>Tracking accuracy disclaimer:</strong> The Anchor Earning system relies on automated activity tracking, anti-AFK checks, browser timers, network connectivity, and server-side logging. These systems are not perfect and may, at times, fail to record activity correctly, double-count, under-count, drop sessions, miscalculate idle vs. active time, or otherwise produce inaccurate earning amounts. Calculated earnings, displayed balances, and pending payouts are estimates only and are not guaranteed.</li>
            <li><strong>Right to adjust, withhold, or reverse:</strong> C24 Club reserves the absolute right, at its sole discretion and without prior notice, to review, audit, recalculate, adjust, withhold, reduce, void, reverse, or deny any Anchor earnings, accumulated balance, or cashout request — including amounts already approved or marked as pending — if we believe (in good faith and at our sole judgment) that the activity was inflated by tracking errors, AFK/idle farming, leaving the panel open without genuine engagement, automation, multiple accounts, shared devices/IPs, policy violations, suspicious patterns, fraud, or any other reason.</li>
            <li><strong>No guaranteed payment:</strong> Participation in the Anchor Earning program does not constitute employment, a contract for services, or a guaranteed payment of any kind. Earning rates, caps, eligibility, and the program itself may be modified, suspended, or terminated at any time without notice. You are not entitled to any specific payout amount, and any cashout is subject to manual review and approval.</li>
            <li><strong>Release of liability:</strong> By participating, you acknowledge and agree that any discrepancy between earnings you believe you accrued and the amount actually paid is a known and accepted risk. You waive any and all claims, demands, disputes, chargebacks, or legal action against C24 Club, its operators, owners, affiliates, and agents arising out of tracking inaccuracies, withheld earnings, denied cashouts, or adjusted balances. Your sole remedy for any disagreement is to discontinue use of the program.</li>
          </ul>
        </section>
