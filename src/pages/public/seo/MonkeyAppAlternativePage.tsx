...
const MonkeyAppAlternativePage = () => (
  ...
  >
    ...
    <p>
      C24 Club is the modern alternative built for everything Monkey got wrong: it's browser-based
      so it can't get pulled from an app store, it's strictly 18+ with real moderation, and the chat
      lasts as long as you both want it to.
    </p>

    <h2>How C24 Club compares to Monkey</h2>
    <table>
      <thead>
        <tr>
          <th>Feature</th>
      ...
      <tbody>
        <tr>
          <td>Platform</td>
          <td>App (often unavailable)</td>
          <td>Any browser, no install</td>
        </tr>
        <tr>
          <td>Conversation length</td>
          <td>15-second cap</td>
          <td>As long as you both want</td>
        </tr>
        <tr>
          <td>Age policy</td>
          <td>13+ historically (problematic)</td>
          <td>Strictly 18+ verified</td>
        </tr>
        <tr>
          <td>Moderation</td>
          <td>Reactive, slow</td>
          <td>Real-time NSFW AI in browser</td>
        </tr>
        <tr>
          <td>Reward minutes</td>
          <td>None</td>
          <td>Gift cards, designer items, PayPal</td>
        </tr>
        <tr>
          <td>Gender-aware matching</td>
          <td>Limited</td>
          <td>Yes, with anchor program</td>
        </tr>
        <tr>
          <td>Sign-up required</td>
          <td>Yes, full account</td>
    ...
    <h2>Why a browser-based platform is more reliable than an app</h2>
    <p>
    ...
    <h2>Real moderation, not promises</h2>
    <ul>
      <li>
        <strong>Pre-blur shield.</strong> The first second of every match is blurred on both sides
        so nobody is exposed to anything they didn't expect.
      </li>
      <li>
        <strong>Browser-based NSFWJS.</strong> A computer-vision model scans the remote stream in
        real time and flags policy violations before they fully load.
      </li>
      <li>
        <strong>Strict 18+ age gate.</strong> The platform doesn't try to market itself to teens.
        Underage accounts are removed and CSAE policy is enforced automatically.
      </li>
      <li>
      ...
      <li>
        <strong>IP-based ban enforcement.</strong> Banned users can't just spin up a new account.
      </li>
    </ul>
...
export default MonkeyAppAlternativePage;